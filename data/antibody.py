...
class AntibodyDataset(BaseDataset):
    ...
    def __init__(
        ...
        super().__init__(mmap_dir, specify_data, specify_index, prompt_jsonl, strict_prompt, use_extended_format, prevent_leakage, prevent_leakage_qkv_only, leakage_marker, use_answer_only_qkv)
        ...
        # Build idx_tup from the already-filtered _properties
        # After filtering, _properties only contains valid samples
        self.idx_tup = []
        if test_mode:       
