...
class MoleculeDataset(PeptideDataset):
    ...
    def __init__(
        ...
        super().__init__(mmap_dir, specify_data, specify_index, cluster, length_type, prompt_jsonl, strict_prompt, prevent_leakage, prevent_leakage_qkv_only, leakage_marker)
        if sample_size:
